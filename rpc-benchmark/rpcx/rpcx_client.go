...
var server_host = flag.String("s", "127.0.0.1:8974", "server ip and port")
var server_debugAddr = flag.String("d", "127.0.0.1:9983", "server ip and port")
...
func main() {
	...
	for i := 0; i < n; i++ {
		...
		go func(i int) {
			...
			dis := client.NewPeer2PeerDiscovery("tcp@"+*server_host, "")
